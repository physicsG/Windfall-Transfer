...
class GuiTests(unittest.TestCase):
    ...
    def test_setting_up_a_mac(self):
        ...
        with (
            mock.patch.object(gui.driver, "install_winusb", return_value=False) as install,
    ...
    def test_remove_lists_what_it_undoes_and_can_be_cancelled(self):
        left = driver.Leftovers(
            [driver.MacDevice("id", 0x1905, True, "WinUSB", "Mac")],
            ["oem140.inf"],
        ...
        self.app.removing = True
        with (
            mock.patch.object(gui.App, "_legacy_leftovers", return_value=[r"C:\Users\me\AppData\Roaming\ConnectApp"]),
            mock.patch.object(gui.messagebox, "askyesno", return_value=False) as ask,
        ):
            self.app._confirm_remove(left)
